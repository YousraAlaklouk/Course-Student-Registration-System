    ...
    public partial class AdminLogIn : Form
    {
        ...
        private void lginButt_Click(object sender, EventArgs e)
        {
            ...
            if (connection.State == ConnectionState.Open)
            {
                    ...
                    SqlCommand cmd = new SqlCommand("SELECT * FROM Admin WHERE Username = '"+txtEmOrUn.Text.ToString() +"' OR Email= '"+txtEmOrUn.Text.ToString()+"'AND Password='"+txtPass.Text.ToString()+"' ", connection);
