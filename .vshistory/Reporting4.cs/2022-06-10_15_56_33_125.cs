        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (radioStu.Checked)
            {
                ...
                try
                {
                    ...
                    connection.Open();
                    SqlDataAdapter cmd = new SqlDataAdapter("SELECT COUNT(DATEDIFF(month, GETDATE(), '" + txtStu.Text + "') ) FROM Students", connection);
...

            {
                try
                {
                    ...
                    connection.Open();
                    SqlDataAdapter cmd = new SqlDataAdapter("SELECT COUNT(DATEDIFF(month, GETDATE(), '" + txtStu.Text + "') ) FROM Instructors", connection);
...

            {
                try
                {
                    ...
                    connection.Open();
                    SqlDataAdapter cmd = new SqlDataAdapter("SELECT COUNT(DATEDIFF(month, GETDATE(), '" + txtStu.Text + "') ) FROM Courses", connection);
