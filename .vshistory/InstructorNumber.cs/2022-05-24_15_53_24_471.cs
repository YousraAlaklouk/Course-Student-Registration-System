    ...
    public partial class InstructorNumber : Form
    {
        ...
        private void labInstNum_Click(object sender, EventArgs e)
        {
            ...
            if (connection.State == ConnectionState.Open)
            {
                ...
                cmd.Parameters.AddWithValue("@first", Instructor_Registration.SetValueForText1.Trim());
                cmd.Parameters.AddWithValue("@last", Instructor_Registration.SetValueForText2.Trim());
