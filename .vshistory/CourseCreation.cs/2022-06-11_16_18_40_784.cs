    ...
    public partial class CourseCreation : Form
    {
        ...
        {// fill the first combo box for instructotrs 
            ...
            */
            ...
            connection.Open();
            SqlCommand sA = new SqlCommand("SELECT FirstName, InstructorNumber FROM Instructors WHERE InstructorNumber != "+ Convert.ToInt16(lab1Ins1Nm.Tex)+" AND InstructorNumber != "+lab1Ins2Nm.Text+" ", connection);
