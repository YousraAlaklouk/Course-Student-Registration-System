    ...
    public partial class CourseCreation : Form
    {
        ...
        {// fill the first combo box for instructotrs 
            ...
            */
            ...
            connection.Open();
            SqlCommand sR = new SqlCommand("SELECT FirstName, InstructorNumber FROM Instructors WHERE InstructorNumber !="+lab1Ins1Nm.Text+"", connection);
            ...
            */
            ...
            connection.Open();
            SqlCommand sA = new SqlCommand("SELECT FirstName, InstructorNumber FROM Instructors WHERE InstructorNumber != "+lab1Ins1Nm.Text+" AND InstructorNumber != "+lab1Ins2Nm.Text+" ", connection);
