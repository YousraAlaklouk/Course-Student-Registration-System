...
namespace Course_Student_Registration_System
{
    public partial class CourseCreation : Form
    {
        ...
        {
            connection.Open();
            SqlCommand sc = new SqlCommand("SELECT FirstName, LastName, InstructorNumber FROM Instructors", connection);
            ...
            connection.Open();
            SqlCommand sR = new SqlCommand("SELECT FirstName, LastName, InstructorNumber FROM Instructors", connection);
            ...
            connection.Open();
            SqlCommand sA = new SqlCommand("SELECT FirstName, LastName, InstructorNumber FROM Instructors", connection);
