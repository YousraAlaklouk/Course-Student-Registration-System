...
/*            @from,@to ,@price,@room,@day ,@time*/
            ...
            if (connection.State == ConnectionState.Open)
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("INSERT INTO Courses(Name,Title, Credit , State, Descreption ,Type , Instructor1Number , Instructor2Number , Instructor3Number )  VALUES (@name , @title, @credit,@state,@desc,@type ,@ins1 , @ins2, @ins3 )", connection);
